...
REPO_NAME = "CustomerLifetimeValue"
AUTHOR_USER_NAME = "BharatSingh Rajpurohit"
SRC_REPO = "CustomerLifetimeValue"
...
setup(
    ...
    description="It is a bussiness solutin webapp. A Webapp which help to increase profit by using machine learning techniques",
